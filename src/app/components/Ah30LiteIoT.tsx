...
export default function Ah30LiteIoT() {
  ...
  const copiarResultadosCSV = () => {
    const linhas = resultados.map(r => {
      ...
      return `${r.serie}, ${r.ip}, ${r.build}, ${r.kernel}, ${r.versao}, ${r.versaoAS}, ${r.memoria}, ${r.funcUso}, ${r.bioUso}`;
    });
                            ...
                            {resultado.erro ? (
                              ...
                              <div className="mt-2 space-y-1 text-xs">
                                <p className="font-semibold text-gray-900 dark:text-gray-100">
                                  {resultado.serie}, {resultado.ip}, {resultado.build}, {resultado.kernel}, {resultado.versao}, {resultado.versaoAS}, {resultado.memoria}, {resultado.funcUso}, {resultado.bioUso}
                                </p>
                                <div className="mt-2 grid grid-cols-2 gap-2 text-xs text-gray-600 dark:text-gray-400">
                                  ...
                                  <div><strong>funcUso:</strong> {resultado.funcUso || '-'}</div>
